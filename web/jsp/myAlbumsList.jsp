            ...
            <div id="gallery">
                <div class="w3-content" style="max-width:800px">
                    ...
                    <div class="w3-row-padding w3-section">
                        <div class="w3-col s1">
                            <img id="image1Thumb" class="demo w3-opacity w3-hover-opacity-off" src="" style="width:9%" height="40" onclick="currentDiv(1)">
                            <img id="image2Thumb" class="demo w3-opacity w3-hover-opacity-off" src="" style="width:9%" height="40" onclick="currentDiv(2)">
                            <img id="image3Thumb" class="demo w3-opacity w3-hover-opacity-off" src="" style="width:9%" height="40" onclick="currentDiv(3)">
                            <img id="image4Thumb" class="demo w3-opacity w3-hover-opacity-off" src="" style="width:9%" height="40" onclick="currentDiv(4)">
                            <img id="image5Thumb" class="demo w3-opacity w3-hover-opacity-off" src="" style="width:9%" height="40" onclick="currentDiv(5)">
                            <img id="image6Thumb" class="demo w3-opacity w3-hover-opacity-off" src="" style="width:9%" height="40" onclick="currentDiv(6)">
                            <img id="image7Thumb" class="demo w3-opacity w3-hover-opacity-off" src="" style="width:9%" height="40" onclick="currentDiv(7)">
                            <img id="image8Thumb" class="demo w3-opacity w3-hover-opacity-off" src="" style="width:9%" height="40" onclick="currentDiv(8)">
                            <img id="image9Thumb" class="demo w3-opacity w3-hover-opacity-off" src="" style="width:9%" height="40" onclick="currentDiv(9)">
                            <img id="image10Thumb" class="demo w3-opacity w3-hover-opacity-off" src="" style="width:9%" height="40" onclick="currentDiv(10)">
                        </div>
                    </div>                    
                </div>
            </div>
