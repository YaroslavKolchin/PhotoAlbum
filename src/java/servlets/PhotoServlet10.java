 ...
 * @author talgat
 */
public class PhotoServlet10 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PhotoServlet10</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet PhotoServlet10 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        {
            System.out.println("servlet 10 file " + PhotoDirectory.getAbsolutePath()+"/"+listOfFiles[9].getName());
            FileInputStream fis = new FileInputStream(PhotoDirectory.getAbsolutePath()+"/"+listOfFiles[9].getName());
        ...
        else if( listOfFiles.length < thisServlet && listOfFiles.length > 0)
        {
            ...
            System.out.println("servlet 10 else file: " + PhotoDirectory.getAbsolutePath()+"/"+listOfFiles[i].getName());
        ...
        else if(listOfFiles.length < 1)
        {
            ...
            System.out.println("servlet 10 if no photos: " + NoPhotoDirectory.getAbsolutePath());
