 ...
 * @author talgat
 */
public class PhotoServlet8 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet PhotoServlet8</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet PhotoServlet8 at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(listOfFiles.length > 7 && listOfFiles.length <= 10)
        {           
            System.out.println("servlet 8 file " + PhotoDirectory.getAbsolutePath()+"/"+listOfFiles[7].getName());
            FileInputStream fis = new FileInputStream(PhotoDirectory.getAbsolutePath()+"/"+listOfFiles[7].getName());
        ...
        {           
            ...
            System.out.println("servlet 8 else file " + PhotoDirectory.getAbsolutePath()+"/"+listOfFiles[i].getName());
        ...
        else if(listOfFiles.length < 1)
        {
            ...
            System.out.println("servlet 8 if no photos: " + NoPhotoDirectory.getAbsolutePath());
