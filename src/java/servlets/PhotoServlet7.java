...
public class PhotoServlet7 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        {
            System.out.println("servlet 7 file: " + PhotoDirectory.getAbsolutePath()+"/"+listOfFiles[6].getName());
        ...
        {           
            ...
            System.out.println("servlet 7 else file: " + PhotoDirectory.getAbsolutePath()+"/"+listOfFiles[i].getName());
        ...
        else if(listOfFiles.length < 1)
        {
            ...
            System.out.println("servlet 7 if no photos: " + NoPhotoDirectory.getAbsolutePath());
